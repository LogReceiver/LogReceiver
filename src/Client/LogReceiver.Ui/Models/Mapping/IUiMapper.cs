...
namespace LogReceiver.Ui.Models.Mapping
{
    ...
    {
        PLogEntry ToPLogEntry(CLogEntry cLogEntry);
        CLogEntry ToCLogEntry(PLogEntry pLogEntry);
        ELogEntry ToELogEntry(PLogEntry pLogEntry);

        PStackTrace ToPStackTrace(CStackTrace cStackTrace);
    }
}
