...
{
    public interface IConfigurationViewModel : IWindowViewViewModel
    {
        IGeneralTabViewModel GeneralTabViewModel { get; }
        IReceiversTabViewModel ReceiversTabViewModel { get; }
    }
}
