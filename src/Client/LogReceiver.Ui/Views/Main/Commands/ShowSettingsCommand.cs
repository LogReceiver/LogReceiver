...
{
    public class ShowSettingsCommand : ViewModelCommandBase<IMainViewModel>, IShowSettingsCommand
    {
        public override void Execute(object parameter)
        {
            MvvmManager.ShowDialog<IConfigurationView, IConfigurationViewModel, IMainViewModel>(ParentViewModel);
        }
    }
}
