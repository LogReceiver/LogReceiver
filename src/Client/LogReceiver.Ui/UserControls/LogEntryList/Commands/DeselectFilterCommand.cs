...
{
    public class DeselectFilterCommand : ViewModelCommandBase<ILogEntryListViewModel>, IDeselectFilterCommand
    {
        public override void Execute(object parameter)
        {
            var pLogEntry = parameter as PLogEntry;
            if (pLogEntry == null)
            {
                return;
            }
            ParentViewModel.FilterSelectionControlModel.DeselectFilter(pLogEntry.LoggerText);
        }
    }
}
