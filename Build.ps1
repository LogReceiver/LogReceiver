...
& $NuGetExe install CommonServiceLocator -OutputDirectory src\Solutions\packages -Version 1.3
& $NuGetExe install structuremap -OutputDirectory src\Solutions\packages -Version 3.0.3.116
